...
extension STUNMessage {
    ...
    static func isSTUN(_ data: Data) -> Bool {
    ...
    static func decode(from input: Data) throws -> STUNMessage {
    ...
    func encodeWithIntegrity(key: Data) -> Data {
...
extension STUNFingerprint {
    ...
    static func compute(data: Data) -> Data {
        Data(compute(data: [UInt8](data)))
    }

    /// Verify FINGERPRINT in a `Data` STUN message.
    static func verify(message input: Data) -> Bool {
