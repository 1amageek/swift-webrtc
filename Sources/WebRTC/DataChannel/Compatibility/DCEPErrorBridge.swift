/// Embedded-clean error bridging from the internal DCEP wire codec's typed
/// throws to the historical ``DataChannelError``.
///
...
extension DataChannelWireError {
    ...
    /// erases to `any Error`).
    func rethrowUnwrapped() throws(DataChannelError) -> Never {
        switch self {
        case .bytes:
